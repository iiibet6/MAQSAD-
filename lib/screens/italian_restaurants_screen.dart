...
Restaurant(
  ...
  'assets/images/picual3.png',
      ...
      type: 'مطاعم',
      category: 'إيطالي',
      description: 'تجربة تجمع بين الطابع العصري والمذاق المميز، يقدم بيكوال مجموعة متنوعة من الوجبات والمشروبات في أجواء حديثة تناسب مختلف المناسبات.',
  ...
  'assets/images/rougaro3.png',
      ...
      type: 'مطاعم',
      category: 'إيطالي',
      description: 'وجهة لعشاق النكهات العالمية، يقدم روقا روكو أطباقًا متنوعة تجمع بين الجودة والتقديم العصري في أجواء مريحة وجذابة.',
  ...
  'assets/images/opalo3.png',
      ...
      type: 'مطاعم',
      category: 'إيطالي',
      description: 'مزيج من الأناقة والمذاق الفريد، يوفر أوبالو تجربة طعام مميزة من خلال قائمة متنوعة وأجواء عصرية تناسب العائلات والأصدقاء.',
  ...
  'assets/images/romaway3.png',
      ...
      type: 'مطاعم',
      description: 'نكهات مستوحاة من المطبخ الإيطالي، يقدم روما وي مجموعة من البيتزا والباستا والأطباق الإيطالية في تجربة تجمع بين الجودة والطابع الأوروبي.',
      category: 'إيطالي',
  ...
  'assets/images/maestro3.png',
      ...
      type: 'مطاعم',
      category: 'إيطالي',
      description: 'وجهة لعشاق البيتزا بمختلف أنواعها، يقدم مايسترو بيتزا تشكيلة واسعة من النكهات والعجائن الطازجة، مع خيارات تناسب جميع الأذواق في أجواء عصرية وسريعة.',
